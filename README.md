...
To delete all object files, use: make clean, command: make fclean , deletes libftprintf.a
...
ft_char: Displays characters
ft_base_10: Displays digits in standart format
ft_base_16: Displays digits in hex format (base 16) 
